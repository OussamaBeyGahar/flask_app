...
class Config:
    ...
    # PROXY_PATH_FOR_PICKLE_1 = parent of SHARE_STANDARD_WORKING (DMAEXPORTTOOL root)
    # PROXY_PATH_FOR_PICKLE_2 = nasbobcat data root (//nasbobcat/bobcat/data)
    PROXY_PATH_FOR_PICKLE_1 = os.environ.get('PROXY_PATH_FOR_PICKLE_1', r'\\naspoc3d.tnext.loc\CATIA_CACHE\BC_WORKSPACE\PRIVATE\DMAEXPORTTOOL')
